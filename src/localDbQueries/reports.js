  ...
  try {
    ...
    const query = `
      ...
      LEFT JOIN (
        ...
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'pre_app_stock' THEN whole_month_operations_and_totals.total_cost END), 0) AS whole_month_operation_id_1_total_cost,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'pre_app_stock' THEN whole_month_operations_and_totals.total_cost_net END), 0) AS whole_month_operation_id_1_total_cost_net,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'pre_app_stock' THEN whole_month_operations_and_totals.total_cost_tax END), 0) AS whole_month_operation_id_1_total_cost_tax,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'new_purchase' THEN whole_month_operations_and_totals.total_cost END), 0) AS whole_month_operation_id_2_total_cost,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'new_purchase' THEN whole_month_operations_and_totals.total_cost_net END), 0) AS whole_month_operation_id_2_total_cost_net,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'new_purchase' THEN whole_month_operations_and_totals.total_cost_tax END), 0) AS whole_month_operation_id_2_total_cost_tax,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'inventory_recount_in' THEN whole_month_operations_and_totals.total_cost END), 0) AS whole_month_operation_id_3_total_cost,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'inventory_recount_in' THEN whole_month_operations_and_totals.total_cost_net END), 0) AS whole_month_operation_id_3_total_cost_net,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'inventory_recount_in' THEN whole_month_operations_and_totals.total_cost_tax END), 0) AS whole_month_operation_id_3_total_cost_tax,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'stock_transfer_in' THEN whole_month_operations_and_totals.total_cost END), 0) AS whole_month_operation_id_4_total_cost,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'stock_transfer_in' THEN whole_month_operations_and_totals.total_cost_net END), 0) AS whole_month_operation_id_4_total_cost_net,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'stock_transfer_in' THEN whole_month_operations_and_totals.total_cost_tax END), 0) AS whole_month_operation_id_4_total_cost_tax,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'initial_stock' THEN whole_month_operations_and_totals.total_cost END), 0) AS whole_month_operation_id_5_total_cost,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'initial_stock' THEN whole_month_operations_and_totals.total_cost_net END), 0) AS whole_month_operation_id_5_total_cost_net,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'initial_stock' THEN whole_month_operations_and_totals.total_cost_tax END), 0) AS whole_month_operation_id_5_total_cost_tax,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'stock_usage' THEN whole_month_operations_and_totals.total_cost END), 0) AS whole_month_operation_id_6_total_cost,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'stock_usage' THEN whole_month_operations_and_totals.total_cost_net END), 0) AS whole_month_operation_id_6_total_cost_net,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'stock_usage' THEN whole_month_operations_and_totals.total_cost_tax END), 0) AS whole_month_operation_id_6_total_cost_tax,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'inventory_recount_out' THEN whole_month_operations_and_totals.total_cost END), 0) AS whole_month_operation_id_7_total_cost,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'inventory_recount_out' THEN whole_month_operations_and_totals.total_cost_net END), 0) AS whole_month_operation_id_7_total_cost_net,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'inventory_recount_out' THEN whole_month_operations_and_totals.total_cost_tax END), 0) AS whole_month_operation_id_7_total_cost_tax,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = '_deprecated_8' THEN whole_month_operations_and_totals.total_cost END), 0) AS whole_month_operation_id_8_total_cost,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = '_deprecated_8' THEN whole_month_operations_and_totals.total_cost_net END), 0) AS whole_month_operation_id_8_total_cost_net,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = '_deprecated_8' THEN whole_month_operations_and_totals.total_cost_tax END), 0) AS whole_month_operation_id_8_total_cost_tax,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = '_deprecated_9' THEN whole_month_operations_and_totals.total_cost END), 0) AS whole_month_operation_id_9_total_cost,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = '_deprecated_9' THEN whole_month_operations_and_totals.total_cost_net END), 0) AS whole_month_operation_id_9_total_cost_net,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = '_deprecated_9' THEN whole_month_operations_and_totals.total_cost_tax END), 0) AS whole_month_operation_id_9_total_cost_tax,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'stock_transfer_out' THEN whole_month_operations_and_totals.total_cost END), 0) AS whole_month_operation_id_10_total_cost,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'stock_transfer_out' THEN whole_month_operations_and_totals.total_cost_net END), 0) AS whole_month_operation_id_10_total_cost_net,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'stock_transfer_out' THEN whole_month_operations_and_totals.total_cost_tax END), 0) AS whole_month_operation_id_10_total_cost_tax,

        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'pre_app_stock' THEN whole_month_operations_and_totals.total_qty END), 0) AS whole_month_operation_id_1_total_qty,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'new_purchase' THEN whole_month_operations_and_totals.total_qty END), 0) AS whole_month_operation_id_2_total_qty,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'inventory_recount_in' THEN whole_month_operations_and_totals.total_qty END), 0) AS whole_month_operation_id_3_total_qty,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'stock_transfer_in' THEN whole_month_operations_and_totals.total_qty END), 0) AS whole_month_operation_id_4_total_qty,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'initial_stock' THEN whole_month_operations_and_totals.total_qty END), 0) AS whole_month_operation_id_5_total_qty,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'stock_usage' THEN whole_month_operations_and_totals.total_qty END), 0) AS whole_month_operation_id_6_total_qty,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'inventory_recount_out' THEN whole_month_operations_and_totals.total_qty END), 0) AS whole_month_operation_id_7_total_qty,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = '_deprecated_8' THEN whole_month_operations_and_totals.total_qty END), 0) AS whole_month_operation_id_8_total_qty,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = '_deprecated_9' THEN whole_month_operations_and_totals.total_qty END), 0) AS whole_month_operation_id_9_total_qty,
        IFNULL(SUM(CASE WHEN whole_month_operations_and_totals.operation_code = 'stock_transfer_out' THEN whole_month_operations_and_totals.total_qty END), 0) AS whole_month_operation_id_10_total_qty
        FROM (
