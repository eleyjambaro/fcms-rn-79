...
export const routes = {
  ...
  batchTransferRequestForm: () => 'BatchTransferRequestForm',
  batchTransferItemSelection: () => 'BatchTransferItemSelection',
  batchTransferRequestDetail: () => 'BatchTransferRequestDetail',
  batchTransferReceive: () => 'BatchTransferReceive',
