...
import SalesOrderListItem from '../../components/salesOrders/SalesOrderListItem';
...
import {getSalesOrderGroups} from '../../localDbQueries/salesOrders';

const SalesOrderList = props => {
  const {filter, showActionButtons = true} = props;
  ...
  const {
    ...
    ['salesOrderGroups', {filter: {...filter, __dateFilter: dateFilter}}],
    getSalesOrderGroups,
    {
  ...
  const renderItem = ({item}) => {
    return (
      <SalesOrderListItem
        item={item}
        onPress={() => {
          navigation.navigate(routes.salesOrderGroupView(), {
            sales_order_group_id: item.sales_order_group_id,
          });
        }}
      />
    );
      ...
      {showActionButtons && (
        <View
          ...
          <Button
            ...
            onPress={() => {
              navigation.navigate(routes.salesOrderRegister());
            }}>
            Add New Sales Order
          </Button>
        </View>
