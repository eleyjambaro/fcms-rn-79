...
const SellingMenuListItem = props => {
    ...
    <Pressable
      ...
      <View style={styles.wrapper}>
        ...
        {/* <View
          ...
          <Text>{`${currencySymbol} ${commaNumber(item.unit_cost)} / ${item.uom_abbrev === 'ea' ? 'pc' : item.uom_abbrev}`}</Text>
        </View> */}
      </View>
...
export default SellingMenuListItem;
