...
import SalesInvoiceListItem from '../../components/salesInvoices/SalesInvoiceListItem';
...
import {getSalesInvoices} from '../../localDbQueries/salesInvoices';
...
const SalesInvoiceList = props => {
  ...
  const {
    ...
    ['salesInvoices', {filter: {...filter, __dateFilter: dateFilter}}],
    getSalesInvoices,
    {
  ...
  const renderItem = ({item}) => {
    return (
      <SalesInvoiceListItem
        item={item}
        onPress={() => {
          navigation.navigate(routes.salesInvoiceView(), {
